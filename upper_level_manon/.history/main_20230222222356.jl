...
function main()
    ...
    if formulation == 1
        ...
        print_table(int_x, x), "x", "-", "int")
        print_table(int_beta, beta), "Beta", "-", "int")
        ...
        print_2Dtable(P_conductor .* int_alpha .* BASE_POWER, "P_conductor", "kW", "float")
        print_2Dtable(Q_conductor .* int_alpha.* BASE_POWER, "Q_conductor", "kVar", "float")
