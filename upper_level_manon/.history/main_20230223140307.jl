...
function main()
    ...
    elseif formulation == 2
        ...
        print_table(abs.(P_s .* beta), "P_s", "kW", "float")
        print_table(abs.(Q_s .* beta), "Q_s", "kVar", "float")
        print_2Dtable(abs.(P_conductor .* alpha), "P_conductor", "kW", "float")
        print_2Dtable(abs.(Q_conductor .* alpha), "Q_conductor", "kVar", "float")
