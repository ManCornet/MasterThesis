...
function main()
    ...
    if formulation == 1
        ...
        print_2table(convert(Array{Int64,2}, alpha), "Alpha" , "-", "int") # 2D dimensions
        ...
        print_2table(P_conductor .* BASE_POWER, "P_conductor", "kW", "float")
        print_2table(Q_conductor .* BASE_POWER, "Q_conductor", "kVar", "float")
