...
function time_dependent_formulation(sets, costs, substation_param, conductor_param, 
    ...
    @variables( model,   
                begin 
                MIN_VOLTAGE^2 <= V_squared[1:T_size, 1:N_size] <= MAX_VOLTAGE^2
                I_squared[t=1:T_size, l=1:L_size, k=1:K_size]
                P_cond_forward[1:T_size, 1:L_size, 1:K_size]
                P_cond_backward[1:T_size, 1:L_size, 1:K_size]
                Q_cond_forward[1:T_size, 1:L_size, 1:K_size]
                Q_cond_backward[1:T_size, 1:L_size, 1:K_size]
                ...
                S_G[1:T_size, 1:N_size]
                S_allocated[1:Ns_size]                          >= 0
                active_losses[1:T_size]                         >= 0
